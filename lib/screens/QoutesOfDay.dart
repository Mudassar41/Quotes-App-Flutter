...
class QoutesofDay extends StatefulWidget {
  @override
  _QoutesofDayState createState() => _QoutesofDayState();
}

class _QoutesofDayState extends State<QoutesofDay> {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "Quotes of the Day",
            style: TextStyle(
                fontFamily: 'Libre Baskerville', color: Customcolors.green),
          ),
        ),
            ...
            child: Column(
              children: [
                FutureBuilder(
                  ...
                  future: _apiData.Allqoutespfday(),
                ),
              ],
            ),
          ),
